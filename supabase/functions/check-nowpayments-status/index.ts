...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Step 5: Check payment status with NOWPayments
    console.log(`[${requestId}] Step 5: Checking payment status with NOWPayments...`);
    ...
    console.log(`[${requestId}] Step 6: Updating payment record...`);
    ...
    if (txUpdateError) {
      console.error(`[${requestId}] ERROR: Failed to update transaction_history:`, txUpdateError);
    } else {
