...
const translations = {
  ...
  pt: {
    ...
    enterMoreInfoRequest: 'Que informações você precisa do usuário?',
    ...
    moreInfoRequested: '✅ Informações Solicitadas',
    ...
    adminRequestedInfo: '📋 Informações Solicitadas ao Usuário:',
    userResponseLabel: '💬 Resposta do Usuário:',
    requestedOn: 'Solicitado',
    respondedOn: 'Respondido',
    adminNotesLabel: 'Notas do Administrador',
    approvedUSDTAmount: 'Quantidade USDT Aprovada',
    approvedUSDTAmountPlaceholder: 'Ex: 50.00',
    ...
    enterValidUSDTAmount: 'Por favor, digite uma quantidade válida de USDT',
    whatInfoNeeded: 'Que informações você precisa do usuário?',
    ...
    rejectReasonPlaceholder: 'Ex: Transação não encontrada na blockchain, valor insuficiente, etc...',
    enterRejectionReasonRequired: 'Por favor, digite um motivo de rejeição',
    enterMoreInfoRequired: 'Por favor, digite as informações que você precisa',
    invalidSession: 'Sessão inválida',
    paymentNotConfirmed: 'ℹ️ Pagamento Não Confirmado',
    paymentNotConfirmedMessage: 'O pagamento ainda não foi confirmado.\n\nStatus atual: {{status}}\n\nPor favor, aguarde até que o pagamento seja confirmado antes de aprovar.',
    paymentAlreadyCredited: 'ℹ️ Já Creditado',
    paymentAlreadyCreditedMessage: 'Este pagamento já foi creditado anteriormente.',
    
    // Manual Payment Credit
    manualPaymentCreditTitle: 'Verificação e Crédito Manual',
    manualPaymentCreditSubtitle: 'Use esta ferramenta para verificar e creditar manualmente pagamentos que não foram processados automaticamente.',
    manualPaymentCreditInfo: 'Esta ferramenta verifica o status do pagamento com NOWPayments e o credita automaticamente se confirmado.',
    orderId: 'ID do Pedido',
    orderIdPlaceholder: 'MXI-1764082913255-cop99k',
    searchPayment: 'Buscar Pagamento',
    ...
    currentMXIBalance: 'Saldo MXI Atual',
    usdtContributed: 'USDT Contribuído',
    paymentAlreadyCredited: '✅ Este pagamento já foi creditado. Não pode ser creditado novamente.',
    paymentNoPaymentId: '⚠️ Este pagamento não tem um ID de Pagamento. Não pode ser verificado com NOWPayments.',
    verifyAndCreditAction: 'Ao verificar este pagamento:',
    verifyAndCreditStep1: '• O status será consultado com NOWPayments',
    verifyAndCreditStep2: '• Se confirmado, {{amount}} MXI serão adicionados ao usuário',
    verifyAndCreditStep3: '• As métricas globais serão atualizadas',
    verifyAndCreditStep4: '• O status do pagamento mudará para "confirmado"',
    verifyAndCreditStep5: '• Esta ação não pode ser desfeita',
    verifyAndCreditPayment: 'Verificar e Creditar Pagamento',
    confirmVerificationAndCredit: 'Confirmar Verificação e Crédito',
    confirmVerificationMessage: 'Tem certeza de que deseja verificar e creditar este pagamento?\n\nUsuário: {{email}}\nValor: {{amount}} MXI\n\nEsta ação verificará o status do pagamento com NOWPayments e o creditará se confirmado.',
    paymentCredited: '✅ Pagamento Creditado',
    paymentCreditedMessage: 'O pagamento foi verificado e creditado com sucesso.\n\n{{amount}} MXI foram adicionados à conta do usuário.\n\nNovo saldo: {{balance}} MXI',
    alreadyCredited: 'ℹ️ Já Creditado',
    alreadyCreditedMessage: 'Este pagamento já foi creditado anteriormente.',
    statusUpdated: 'ℹ️ Status Atualizado',
    statusUpdatedMessage: 'Status do pagamento: {{status}}\n\nO pagamento ainda não foi confirmado pelo NOWPayments. Não pode ser creditado neste momento.',
    errorVerifyingPayment: 'Erro ao verificar o pagamento',
    paymentNotFound: 'Pagamento não encontrado',
    enterOrderId: 'Por favor, digite um ID de Pedido',
    instructions: 'Instruções',
    instructionsText: '1. Digite o ID do Pedido do pagamento que deseja verificar\n2. Clique em "Buscar Pagamento" para ver os detalhes\n3. Verifique se as informações estão corretas\n4. Clique em "Verificar e Creditar Pagamento" para processar\n\n⚠️ Aviso: Esta ferramenta verifica automaticamente com NOWPayments antes de creditar. Só creditará se o pagamento estiver confirmado no NOWPayments.',
    ...
    pleaseEnterReply: 'Por favor, digite uma resposta',
    userNotAuthenticated: 'Usuário não autenticado',
    replySentSuccessfully: 'Resposta enviada com sucesso',
    failedToSendReply: 'Falha ao enviar resposta',
    statusUpdatedTo: 'Status atualizado para {{status}}',
    failedToUpdateStatus: 'Falha ao atualizar status',
    
    // Settings
    systemSettings: 'Configurações do Sistema',
    configurePlatformParameters: 'Configurar parâmetros da plataforma',
    ...
    coreMetricsDescription: 'Métricas principais da plataforma e informações de fases',
    currentMXIPrice: 'Preço Atual do MXI (USDT)',
    currentPhase: 'Fase Atual',
    totalTokensSold: 'Total de Tokens Vendidos',
    totalPoolMembers: 'Total de Membros do Pool',
    coreSettings: 'Configurações Principais',
    coreSettingsDescription: 'Parâmetros críticos de configuração da plataforma',
    transactionLimits: 'Limites de Transação',
    transactionLimitsDescription: 'Restrições de compra e retirada',
    withdrawalSettings: 'Configurações de Retirada',
    withdrawalSettingsDescription: 'Configuração de liberação de retiradas de MXI',
    editSetting: 'Editar Configuração',
    newValue: 'Novo Valor',
    enterNewValue: 'Digite o novo valor',
    current: 'Atual',
    changingSettingWarning: 'Alterar esta configuração afetará todos os usuários imediatamente. Por favor, verifique o valor antes de salvar.',
    saveChanges: 'Salvar Alterações',
    settingUpdatedSuccessfully: 'Configuração atualizada com sucesso',
    failedToSaveSetting: 'Falha ao salvar configuração',
    pleaseEnterValidNumber: 'Por favor, digite um número válido',
    
    // Vesting Analytics
    vestingAnalyticsTitle: 'Análise de Vesting',
    verifyingAccess: 'Verificando acesso...',
    noPermissionsAccess: 'Você não tem permissões para acessar esta seção',
    
    // Withdrawal Approvals
    withdrawalApprovals: 'Aprovações de Retirada',
    requestsCount: '{{count}} solicitação(ões)',
    pending: 'Pendentes',
    all: 'Todas',
    noWithdrawalRequests: 'Não há solicitações de retirada para revisar',
    requested: 'Solicitado',
    to: 'Para',
    ...
    addNotesOrRejectionReason: 'Adicione notas ou motivo de rejeição...',
    approve: 'Aprovar',
    reject: 'Rejeitar',
    markAsCompleted: 'Marcar como Concluído',
    approveWithdrawal: 'Aprovar Retirada',
    approveWithdrawalConfirm: 'Tem certeza de que deseja aprovar esta solicitação de retirada?',
    withdrawalApprovedSuccess: 'Retirada aprovada e definida para processamento',
    failedToApproveWithdrawal: 'Falha ao aprovar retirada',
    completeWithdrawal: 'Concluir Retirada',
    completeWithdrawalConfirm: 'Marcar esta retirada como concluída? Isso significa que os fundos foram enviados.',
    withdrawalCompletedSuccess: 'Retirada marcada como concluída',
    failedToCompleteWithdrawal: 'Falha ao concluir retirada',
    rejectWithdrawal: 'Rejeitar Retirada',
    rejectWithdrawalConfirm: 'Tem certeza de que deseja rejeitar esta solicitação de retirada?',
    provideRejectionReason: 'Por favor, forneça um motivo para a rejeição',
    withdrawalRejectedSuccess: 'Retirada rejeitada',
    failedToRejectWithdrawal: 'Falha ao rejeitar retirada',
    
    // Admin Metrics Dashboard
    appMetrics: '📊 Métricas do Aplicativo',
    usersMetrics: '👥 Usuários',
    totalUsers: 'Total de Usuários',
    activeUsers: 'Usuários Ativos',
    blockedUsers: 'Usuários Bloqueados',
    activationRate: 'Taxa de Ativação',
    financialMetrics: '💰 Finanças',
    mxiDistributed: 'MXI Distribuído',
    averageMXIPerUser: 'MXI Médio/Usuário',
    averageUSDTPerUser: 'USDT Médio/Usuário',
    referralsAndCommissions: '🔗 Indicações e Comissões',
    totalReferrals: 'Total de Indicações',
    totalCommissions: 'Total de Comissões',
    commissionAmount: 'Valor das Comissões',
    referralsPerUser: 'Indicações/Usuário',
    vestingMetrics: '🔒 Métricas de Vesting',
    mxiLocked: 'MXI Bloqueado',
    mxiReleased: 'MXI Liberado',
    mxiPending: 'MXI Pendente',
    vestingParticipants: 'Participantes do Vesting',
    averageVestingPerUser: 'Vesting Médio/Usuário',
    totalYieldGenerated: 'Rendimento Total Gerado',
    activeGenerators: 'Geradores Ativos',
    percentReleased: '% Liberado',
    presaleStatistics: '🚀 Estatísticas de Pré-venda (Dados Reais)',
    currentPhaseLabel: 'Fase Atual',
    price: 'Preço',
    mxiSoldReal: 'MXI Vendidos (Real)',
    totalPresaleGoal: 'Meta Total da Pré-venda',
    generalProgress: 'Progresso Geral',
    valueRaised: 'Valor Arrecadado',
    presaleStart: 'Início da Pré-venda',
    presaleEnd: 'Fim da Pré-venda',
    phaseDetails: '📅 Detalhes por Fase',
    start: 'Início',
    end: 'Fim',
    sold: 'Vendidos',
    goal: 'Meta',
    generalSummary: '📈 Resumo Geral',
    totalValueRaised: 'Valor Total Arrecadado',
    tokensSoldReal: 'Tokens Vendidos (Real)',
    presaleProgress: 'Progresso da Pré-venda',
    commissionsPaid: 'Comissões Pagas',
    mxiInVesting: 'MXI em Vesting',
    yieldGenerated: 'Rendimento Gerado',
    loadingMetrics: 'Carregando métricas...',
    couldNotLoadMetrics: 'Não foi possível carregar as métricas',
    
    // NowPayments Modal
    multiCryptoPayment: 'Pagamento Multi-Cripto',
    enterAmount: '💰 Digite o Valor',
    minimumAmount: 'Valor mínimo: 2 USDT',
    amountInUSDT: 'Valor em USDT',
    exampleAmount: 'Ex: 10',
    youWillReceive: 'Você receberá:',
    priceLabel: 'Preço',
    perMXI: 'por MXI',
    quickAmounts: 'Valores rápidos:',
    selectCryptocurrency: '🪙 Selecione a Criptomoeda',
    availableCryptocurrencies: '{{count}}+ criptomoedas disponíveis',
    searchByNameCodeNetwork: 'Buscar por nome, código ou rede...',
    allCurrencies: 'Todas',
    stablecoins: '💵 Stablecoins',
    majorCryptos: '⭐ Principais',
    altcoins: '🔷 Altcoins',
    results: '{{count}} resultado(s)',
    noResultsFound: 'Nenhum resultado encontrado',
    tryAnotherSearch: 'Tente outro termo de busca',
    continueToPayment: 'Continuar para o Pagamento',
    completePayment: '💳 Complete o Pagamento',
    timeRemaining: 'Tempo restante',
    amountToPay: 'Valor a Pagar',
    network: 'Rede',
    paymentAddress: 'Endereço de Pagamento',
    instructionsTitle: '📋 Instruções:',
    instruction1: '1. Envie exatamente {{amount}} {{currency}} para o endereço mostrado',
    instruction2: '2. Use a rede {{network}}',
    instruction3: '3. Certifique-se de cobrir as taxas de rede',
    instruction4: '4. O pagamento será confirmado automaticamente',
    instruction5: '5. Você receberá uma notificação quando for creditado',
    instruction6: '6. O sistema verifica o status a cada 30 segundos',
    openPaymentPage: 'Abrir Página de Pagamento',
    paymentWarning: '⚠️ Envie apenas {{currency}} na rede {{network}}. Enviar outra moeda ou usar outra rede resultará em perda de fundos.',
    paymentExpired: '⏰ Pagamento Expirado',
    paymentExpiredMessage: 'O tempo para completar o pagamento expirou. Por favor, crie um novo pagamento.',
    pleaseCompleteAllFields: 'Por favor, complete todos os campos',
    minimumIs2USDT: 'O valor mínimo é 2 USDT',
    errorCreatingPayment: 'Não foi possível criar o pagamento. Por favor, tente novamente.',
    couldNotOpenBrowser: '⚠️ Não foi possível abrir o navegador',
    copyURLManually: 'Você pode copiar a URL e abri-la manualmente no seu navegador:\n\n{{url}}',
    copyURL: 'Copiar URL',
    paymentPageOpened: '✅ Página de Pagamento Aberta',
    paymentPageOpenedMessage: 'A página de pagamento foi aberta no seu navegador. Complete o pagamento e retorne aqui para verificar o status.',
    paymentConfirmed: '✅ Pagamento Confirmado',
    paymentConfirmedMessage: 'Seu pagamento foi confirmado e os MXI foram creditados na sua conta.',
    viewBalance: 'Ver Saldo',
    ...
    minimumWithdrawalIs50MXI: 'A retirada mínima é 50 MXI',
    ...
    totalMXIEarned: 'Total de MXI Ganho',
    ...
    withdrawalsInUSDTETH: 'Todas as retiradas são processadas em USDT (rede ETH)',
    amountMXI: 'Valor (MXI)',
    maximum: 'Máximo',
    ...
    mxiLaunchRequiredForPurchasedAndVesting: 'Lançamento do MXI necessário para retiradas de comprados e vesting',
    importantInformation: 'Informações Importantes',
    withdrawalsInUSDTETHInfo: '• Todas as retiradas são processadas em USDT na rede Ethereum',
    conversionInfo: '• Taxa de conversão: 1 MXI = 0.40 USDT',
    mxiCommissionsInfo: '• MXI de comissões podem ser retirados imediatamente',
    mxiTournamentsInfo: '• MXI de torneios podem ser retirados imediatamente',
    mxiVestingInfo: '• MXI de vesting requer 10 indicações ativas',
    mxiPurchasedInfo: '• MXI comprados requer lançamento do MXI',
    ...
    youNeedAtLeast10ActiveReferrals: 'Você precisa de pelo menos 10 indicações ativas para retirar vesting. Você tem atualmente {{count}}.',
    withdrawalNotAvailable: 'Retirada Não Disponível',
    withdrawalsWillBeAvailableAfterLaunch: 'Retiradas de {{type}} estarão disponíveis após o lançamento do MXI ({{days}} dias restantes)',
    notEligible: 'Não Elegível',
    youNeedAtLeast5ActiveReferrals: 'Você precisa de pelo menos 5 indicações ativas e KYC aprovado para retirar',
    confirmWithdrawal: 'Confirmar Retirada',
    youAreAboutToWithdraw: 'Você está prestes a retirar {{amount}} {{type}} (≈ {{usdt}} USDT). Continuar?',
    requestSent: 'Solicitação Enviada',
    yourWithdrawalRequestHasBeenSent: 'Sua solicitação de retirada de {{amount}} {{type}} (≈ {{usdt}} USDT) foi enviada com sucesso',
    couldNotProcessWithdrawal: 'Não foi possível processar a retirada',
    errorProcessingWithdrawal: 'Erro ao processar retirada',
    youDoNotHaveEnoughAvailable: 'Você não tem {{type}} suficiente disponível',
    
    // Deposit Screen
    deposit: 'Depositar',
    buyMXIWithMultipleOptions: 'Compre MXI com várias opções',
    usdtContributed: 'USDT Contribuído',
    ...
    generalProgress: 'Progresso Geral',
    of: 'de',
    totalMXIDelivered: 'Total de MXI Entregue',
    ...
    // Vesting Counter
    activeVesting: 'Vesting Ativo',
    noBalanceInVesting: 'Sem saldo em vesting',
    accumulatedYieldTotal: 'Rendimento Acumulado Total',
    updatingEverySecond: 'Atualizando a cada segundo',
    balanceInVesting: 'Saldo em Vesting',
    ...
    basedOnPurchasedMXI: 'Baseado em {{amount}} MXI comprados',
    vestingInfoNoPurchase: 'Compre MXI para começar a gerar rendimentos de 3% mensais.',
    vestingInfoWithPurchase: 'O vesting gera um rendimento de 3% mensal sobre seus MXI comprados. O contador atualiza a cada segundo e recalcula automaticamente com cada compra ou mudança de saldo. Este saldo não pode ser retirado até que a moeda seja lançada oficialmente.',
    nearMonthlyCapWarning: 'Perto do limite mensal de 3%',
    
    // Universal MXI Counter
    adminVesting: 'Vesting do Administrador',
    activeVestingMining: '🔒 Vesting MXI (Mineração Ativa)',
    onlyDirectlyPurchasedMXI: 'Apenas MXI comprados diretamente',
    vestingWarning: '⚠️ O vesting é calculado APENAS sobre os MXI comprados diretamente. As comissões NÃO geram vesting.',
    purchasedMXIVestingBase: 'MXI Comprados (Base de Vesting)',
    accumulatedYield: 'Rendimento Acumulado',
    noMXIInVesting: 'Não há MXI em vesting. Apenas MXI comprados diretamente geram rendimento de vesting.',
    vestingInfoNote: 'ℹ️ Taxa de mineração: 0.005% por hora do seu MXI comprado. Apenas MXI comprados diretamente geram rendimento de vesting. As comissões NÃO geram vesting. Para reivindicar seu MXI minerado, você precisa de 5 indicações ativas, 10 dias de associação e aprovação KYC. Lembre-se de que para vesting você deve ter 10 indicações ativas e será desbloqueado assim que o token for lançado e listado nas exchanges.',
    
    // Contrataciones (Buy MXI)
    buyMXI: 'Comprar MXI',
    diagnosticSystem: 'Sistema de Diagnóstico',
    ifExperiencingProblems: 'Se você está tendo problemas ao criar pagamentos, use esta ferramenta para verificar a configuração do servidor.',
    testServerConfiguration: 'Testar Configuração do Servidor',
    importantPaymentInfo: 'Informações Importantes de Pagamento',
    paymentsProcessedInUSDT: 'Os pagamentos são processados em USDT (ERC20)',
    useCorrectNetwork: 'Use a rede correta (Ethereum)',
    paymentExpiresIn1Hour: 'O pagamento expira em 1 hora',
    tokensAutomaticallyCredited: 'Os tokens são creditados automaticamente',
    currentPresalePhaseTitle: 'Fase Atual da Pré-venda',
    activePhaseLabel: 'Fase Ativa',
    currentPriceLabel: 'Preço Atual',
    tokensSoldLabel: 'Tokens Vendidos',
    untilNextPhaseLabel: 'Até a Próxima Fase',
    ...
    receiveMXITokens: 'Receba tokens MXI a preço preferencial',
    generateYield: 'Gere rendimento em seus MXI',
    earnCommissions: 'Ganhe comissões por indicações',
    participateInLiquidityPool: 'Participe do pool de liquidez',
    earlyAccessToLaunch: 'Acesso antecipado ao lançamento',
    preferentialPresalePrice: 'Preço preferencial de pré-venda',
    serverConfigurationError: '⚠️ Erro de Configuração do Servidor',
    paymentSystemNotConfigured: 'O sistema de pagamentos não está configurado corretamente no servidor.',
    problemDetected: 'Problema Detectado:',
    nowPaymentsCredentialsNotConfigured: 'As credenciais do NOWPayments não estão configuradas nas Edge Functions do Supabase',
    solutionForAdministrator: 'Solução (Para Administrador):',
    goToSupabaseDashboard: '1. Vá para o Dashboard do Supabase',
    navigateToProjectSettings: '2. Navegue para Configurações do Projeto → Edge Functions',
    addEnvironmentVariables: '3. Adicione as seguintes variáveis de ambiente:',
    redeployEdgeFunctions: '4. Reimplante as Edge Functions',
    contactAdministrator: 'Se você não é o administrador, por favor, entre em contato com o suporte técnico.',
    configurationCorrect: '✅ Configuração Correta',
    environmentVariablesConfigured: 'As variáveis de ambiente estão configuradas corretamente.',
    errorModalTitle: '❌ Erro Detalhado',
    errorMessage: 'Mensagem de Erro',
    errorCode: 'Código de Erro',
    requestID: 'ID da Solicitação',
    httpStatusCode: 'Código de Status HTTP',
    timestamp: 'Marca de Tempo',
    copyDetailsToConsole: 'Copiar Detalhes para o Console',
    detailsCopied: 'Detalhes Copiados',
    errorDetailsCopiedToConsole: 'Os detalhes do erro foram copiados para o console.',
    sessionError: 'Erro de Sessão',
    mustLoginToContinue: 'Você deve estar logado para continuar',
    connectionError: 'Erro de Conexão',
    unknownErrorText: 'Ocorreu um erro desconhecido',
    serverReturnedInvalidResponse: 'O servidor retornou uma resposta inválida',
    noPaymentURLReceived: 'Nenhuma URL de pagamento foi recebida',
    paymentCreated: '✅ Pagamento Criado',
    errorOpeningBrowser: '⚠️ Erro ao Abrir Navegador',
    couldNotOpenBrowserAutomatically: 'Não foi possível abrir o navegador automaticamente. Você pode copiar a URL e abri-la manualmente:\n\n{{url}}',
    paymentCompleted: '✅ Pagamento Concluído',
    youHaveReceived: 'Você recebeu {{amount}} MXI na sua conta!',
    ...
    paymentTimeExpired: 'O tempo para completar o pagamento expirou.',
    ...
    noPaymentsYet: 'Você ainda não tem pagamentos registrados.\nFaça seu primeiro pagamento em USDT para começar.',
    payToUSDT: 'Pagar em USDT',
    ...
    viewHistoryAndRequestManualVerification: 'Veja seu histórico de pagamentos e solicite verificação manual se um pagamento não foi creditado automaticamente.',
    ...
    administratorReviewingPayment: 'O administrador está revisando seu pagamento',
    ...
    requestManualVerificationOfUSDT: 'Solicite verificação manual de seus pagamentos em USDT feitos diretamente para o endereço da plataforma.',
    selectPaymentNetwork: 'Selecione a Rede de Pagamento',
    eachNetworkValidatesIndependently: 'Cada rede valida independentemente',
    networkDescription: 'Pagamentos em {{network}}',
    transactionHashTxHash: 'Hash da Transação (TxHash)',
    ...
    responseSentToAdministrator: 'Sua resposta foi enviada ao administrador.',
    ...
    existingRequestMessage: 'Você já tem uma solicitação de verificação para este pagamento com status: {{status}}',
    ...
    requestSentMessage: 'Sua solicitação de verificação manual foi enviada. Um administrador a revisará em breve.',
    ...
    invalidHash: 'Hash Inválido',
    hashMustStartWith0x: 'O hash deve começar com 0x e ter 66 caracteres de comprimento (atualmente {{count}} caracteres)',
    ...
    selectNetworkYouWillUse: '1. Selecione a rede que você usará ({{label}})',
    sendUSDTFromAnyWallet: '2. Envie USDT de qualquer carteira',
    minimumAmountLabel: '3. Valor mínimo: {{min}} USDT',
    copyTransactionHash: '4. Copie o hash da transação',
    pasteHashAndVerify: '5. Cole o hash aqui e verifique',
    youWillReceiveMXI: '6. Você receberá {{rate}} MXI por USDT',
    recipientAddress: 'Endereço do Destinatário ({{label}})',
    onlySendUSDTOnNetwork: '⚠️ Envie apenas USDT na rede {{network}} ({{label}}). Enviar em outra rede resultará em perda de fundos.',
    mxiCalculator: 'Calculadora MXI',
    verifyAutomatically: 'Verificar Automaticamente',
    requestManualVerificationTitle: 'Solicitar Verificação Manual',
    doYouWantToSendManualRequest: 'Deseja enviar uma solicitação de verificação manual para esta transação?\n\nRede: {{network}} ({{label}})\nHash: {{hash}}',
    ...
    paymentsOnETHOnlyValidatedOnETH: 'Pagamentos no Ethereum são validados apenas no Ethereum',
    paymentsOnBNBOnlyValidatedOnBNB: 'Pagamentos na BNB Chain são validados apenas na BNB Chain',
    paymentsOnPolygonOnlyValidatedOnPolygon: 'Pagamentos no Polygon são validados apenas no Polygon',
    ...
    transactionNotFoundText: 'A transação não foi encontrada na rede {{network}}. Por favor, verifique:\n\n• O hash está correto\n• A transação foi feita em {{network}}\n• A transação tem pelo menos 3 confirmações',
    waitingConfirmations: 'Aguardando Confirmações',
    waitingConfirmationsText: '{{message}}\n\nConfirmações: {{confirmations}}/{{required}}\n\nPor favor, aguarde alguns minutos e tente novamente.',
    insufficientAmountTitle: 'Valor Insuficiente',
    insufficientAmountText: 'O valor da transação é menor que o mínimo necessário.\n\n{{message}}\n\nValor: {{usdt}} USDT\nMínimo: {{minimum}} USDT',
    ...
    invalidTransferText: 'Nenhuma transferência válida de USDT foi encontrada para o endereço {{address}} na rede {{network}}.',
    transactionFailed: 'Transação Falhou',
    transactionFailedText: 'A transação falhou na blockchain. Por favor, verifique o status da transação.',
    ...
    configurationErrorText: 'Erro de configuração do servidor: {{message}}',
    incorrectNetwork: 'Rede Incorreta',
    incorrectNetworkText: 'A transação não foi feita na rede selecionada.',
    authenticationError: 'Erro de Autenticação',
    incompleteData: 'Dados Incompletos',
    incompleteDataText: 'Alguns dados necessários estão faltando.',
    databaseError: 'Erro de Banco de Dados',
    rpcConnectionError: 'Erro de Conexão RPC',
    rpcConnectionErrorText: 'Não foi possível conectar à rede blockchain: {{message}}',
    internalError: 'Erro Interno',
    internalErrorText: 'Ocorreu um erro interno do servidor: {{message}}',
    connectionErrorText: 'Erro de conexão: {{message}}',
    paymentConfirmedTitle: '✅ Pagamento Confirmado',
    paymentConfirmedText: 'Seu pagamento foi confirmado!\n\nVocê recebeu {{amount}} MXI\nRede: {{network}}\nUSDT: {{usdt}}',
    mustLoginToTest: 'Você deve estar logado para testar',
    couldNotTestEnvironmentVariables: 'Não foi possível testar as variáveis de ambiente: {{message}}',
    
    // Admin User Management
    completeUserManagement: '⚙️ Gerenciamento Completo de Usuário',
    loadingDetails: 'Carregando detalhes...',
    couldNotLoadUserDetails: 'Não foi possível carregar os detalhes do usuário. Por favor, tente novamente.',
    retry: 'Tentar Novamente',
    referrerInformation: '👤 Informações do Indicador',
    referrerName: 'Nome:',
    referrerEmail: 'E-mail:',
    referrerCode: 'Código:',
    noReferrerAssigned: 'Nenhum indicador atribuído',
    balanceSummary: 'Resumo do Saldo',
    totalBalanceLabel: 'Saldo Total',
    usdtContributedLabel: 'USDT Contribuído',
    detailedBalances: 'Saldos Detalhados',
    mxiPurchasedDetailed: '💰 MXI Comprado',
    mxiCommissionsDetailed: '💸 MXI Comissões',
    mxiChallengesDetailed: '🏆 MXI Desafios',
    mxiVestingDetailed: '🔒 MXI Vesting',
    referralStats: 'Estatísticas de Indicações',
    referralsLabel: 'Indicações',
    activesLabel: 'Ativos',
    commissionsLabel: 'Comissões',
    totalLabel: 'Total',
    balanceManagement: '💰 Gerenciamento de Saldos',
    addNoCommission: 'Adicionar\nSem Comissão',
    addWithCommission: 'Adicionar\nCom Comissão',
    subtractBalance: 'Subtrair\nSaldo',
    addVesting: 'Adicionar\nVesting',
    referralsCount: '👥 Indicações ({{count}})',
    noReferrals: 'Sem indicações',
    commissionsCount: '💸 Comissões ({{count}})',
    noCommissions: 'Sem comissões',
    addBalance: '➕ Adicionar Saldo',
    subtractBalanceTitle: '➖ Subtrair Saldo',
    generalBalance: 'Saldo Geral',
    vestingBalance: 'Vesting',
    tournamentBalance: 'Torneio',
    mxiAmount: 'Quantidade de MXI',
    confirmAction: 'Confirmar',
    updateReferrer: '🔗 Atualizar Indicador',
    enterNewReferrerCode: 'Digite o código do novo indicador ou deixe vazio para remover',
    referrerCodeLabel: 'Código do Indicador',
    referrerCodePlaceholder: 'MXI123456 (vazio para remover)',
    currentReferrer: 'Indicador Atual:',
    updateButton: 'Atualizar',
    linkReferral: '🔗 Vincular Indicação',
    userEmail: 'E-mail do Usuário',
    userEmailPlaceholder: 'usuario@exemplo.com',
    referrerCodeInput: 'Código do Indicador',
    referrerCodeInputPlaceholder: 'MXI123456',
    linkButton: 'Vincular',
    deleteCommission: '🗑️ Excluir Comissão',
    areYouSureDeleteCommission: 'Tem certeza de que deseja excluir esta comissão?',
    deleteButton: 'Excluir',
    commissionDeleted: '✅ Comissão excluída',
    errorDeletingCommission: '❌ Erro ao excluir comissão',
    deleteReferral: '🗑️ Excluir Indicação',
    areYouSureDeleteReferral: 'Tem certeza de que deseja excluir esta indicação?',
    referralDeleted: '✅ Indicação excluída',
    errorDeletingReferral: '❌ Erro ao excluir indicação',
    
    // User Management
    userManagement: '👥 Gerenciamento de Usuários',
    loadingUsers: 'Carregando usuários...',
    searchPlaceholder: 'Buscar por nome, e-mail, ID ou código...',
    actives: 'Ativos',
    inactive: 'Inativos',
    blocked: '🚫 Bloqueados',
    ...
    // KYC Approvals
    kycApprovals: 'Aprovações KYC',
    verifications: 'verificação(ões)',
    allVerifications: 'Todas',
    noKYCToReview: 'Não há verificações KYC para revisar',
    submitted: 'Enviado',
    tapToReview: 'Toque para revisar',
    kycReview: 'Revisão de Verificação KYC',
    ...
    notesPlaceholder: 'Adicione notas ou motivo de rejeição...',
    rejectionPlaceholder: 'Explique por que foi rejeitado e o que o usuário deve corrigir...',
    approveKYCTitle: 'Aprovar KYC',
    approveKYCConfirm: 'Tem certeza de que deseja aprovar esta verificação KYC?',
    kycApprovedSuccess: 'Verificação KYC aprovada com sucesso',
    errorApprovingKYC: 'Erro ao aprovar verificação KYC',
    rejectKYCTitle: 'Rejeitar KYC',
    rejectKYCConfirm: 'Tem certeza de que deseja rejeitar esta verificação KYC? O usuário poderá reenviar seus documentos.',
    verificationRejected: 'Verificação Rejeitada',
    verificationRejectedMessage: 'A verificação KYC foi rejeitada. O usuário receberá uma notificação com o motivo da rejeição e poderá reenviar seus documentos.',
    errorRejectingKYC: 'Erro ao rejeitar verificação KYC',
    rejectedInfo: 'Esta verificação foi rejeitada. O usuário pode reenviar seus documentos corrigidos.',
    ...
    iHaveReadAndAccept: 'Eu li e aceito os',
