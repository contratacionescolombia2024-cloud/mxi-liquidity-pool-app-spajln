...
const translations = {
  ...
  pt: {
    ...
    chartShowsDynamicBalance: 'O gráfico mostra mudanças de saldo dinamicamente. Cada ponto representa uma transação.',
    balanceChanges: 'Mudanças de Saldo',
    balanceChangeTimestamps: 'Marcas de Tempo de Mudanças de Saldo',
