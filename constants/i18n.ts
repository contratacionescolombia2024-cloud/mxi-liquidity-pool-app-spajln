...
const translations = {
  en: {
    ...
    withdrawalsInUSDTETH: 'Withdrawals in USDT(ETH): All withdrawals are processed in USDT on the Ethereum network',
    conversion: 'Conversion',
    mxiCommissionsAvailableImmediately: 'MXI Commissions: Available for immediate withdrawal (requires 5 active referrals + KYC)',
    mxiTournamentsAvailableSameAsCommissions: 'MXI Tournaments: Available for withdrawal same as commissions',
    mxiVestingRequires10Referrals: 'MXI Vesting: Requires 10 referrals with MXI purchases + official launch',
    mxiPurchasedLockedUntilLaunch: 'MXI Purchased: Locked until official MXI launch',
    realTimeUpdate: 'Real-Time Update: Vesting balances update every second',
  ...
  es: {
    ...
    mxiWonInTournaments: 'MXI ganado en torneos y desafíos',
    ...
    withdrawalsInUSDTETH: 'Retiros en USDT(ETH): Todos los retiros se procesan en USDT en la red Ethereum',
    conversion: 'Conversión',
    mxiCommissionsAvailableImmediately: 'MXI Comisiones: Disponibles para retiro inmediato (requiere 5 referidos activos + KYC)',
    mxiTournamentsAvailableSameAsCommissions: 'MXI Torneos: Disponibles para retiro de la misma forma que las comisiones',
    mxiVestingRequires10Referrals: 'MXI Vesting: Requiere 10 referidos con compras de MXI + lanzamiento oficial',
    mxiPurchasedLockedUntilLaunch: 'MXI Comprados: Bloqueados hasta el lanzamiento oficial de MXI',
    realTimeUpdate: 'Actualización en Tiempo Real: Los balances de vesting se actualizan cada segundo',
  ...
  pt: {
    ...
    withdrawalsInUSDTETH: 'Saques em USDT(ETH): Todos os saques são processados em USDT na rede Ethereum',
    conversion: 'Conversão',
    mxiCommissionsAvailableImmediately: 'MXI Comissões: Disponíveis para saque imediato (requer 5 indicações ativas + KYC)',
    mxiTournamentsAvailableSameAsCommissions: 'MXI Torneios: Disponíveis para saque da mesma forma que as comissões',
    mxiVestingRequires10Referrals: 'MXI Vesting: Requer 10 indicações com compras de MXI + lançamento oficial',
    mxiPurchasedLockedUntilLaunch: 'MXI Comprados: Bloqueados até o lançamento oficial de MXI',
    realTimeUpdate: 'Atualização em Tempo Real: Os saldos de vesting são atualizados a cada segundo',
