...
const translations = {
  ...
  pt: {
    ...
    kycRequiredMessage: 'Você precisa completar a verificação KYC antes de reivindicar seu MXI minerado. Por favor, vá para a seção KYC para verificar sua identidade.',
    ...
    pleaseEnterYourWalletAddress: 'Por favor, insira seu endereço de carteira',
    insufficientBalance: 'Saldo Insuficiente',
    ...
    onlyUseCommissionsOrChallenges: 'Você só pode usar MXI de comissões ou ganhos de desafios',
    players: 'Jogadores',
    ...
    live: 'Ao Vivo',
    referralSystem: 'Sistema de Referências',
    earnCommissionsFrom3Levels: 'Ganhe comissões de 3 níveis ao indicar amigos',
    actives: 'ativos',
    ...
    shareYourReferralCode: 'Compartilhe seu código de referência nas redes sociais',
    ...
    amountToWithdrawMXI: 'Quantidade a Retirar (MXI)',
    minimum50MXIRequired: 'Mínimo 50 MXI',
    invalidAmountEnterValid: 'Quantidade Inválida. Por favor, insira uma quantidade válida',
    ...
    requirementsNotMetNeed5Referrals: 'Você precisa de 5 referências ativas que compraram o mínimo de MXI.\n\nAtualmente você tem: {{count}} referências ativas',
    ...
    winnerAnnouncedOnSocialMedia: 'Vencedor anunciado nas redes sociais',
    ...
    paymentsOnlyValidatedOnNetwork: 'Pagamentos em {{network}} são validados apenas na rede {{network}}',
    paymentInstructions: 'Instruções de Pagamento',
    selectNetworkYouWillUse: 'Selecione a rede que você vai usar ({{label}})',
    sendUSDTFromAnyWallet: 'Envie USDT de qualquer carteira para o endereço do destinatário',
    minimumAmount: 'Valor mínimo: {{min}} USDT',
    copyTransactionHash: 'Copie o hash da transacção (txHash)',
    ...
    paymentsOnETHOnlyValidatedOnETH: 'Pagamentos em ETH são validados apenas na rede Ethereum',
    paymentsOnBNBOnlyValidatedOnBNB: 'Pagamentos em BNB são validados apenas na rede BNB Chain',
    paymentsOnPolygonOnlyValidatedOnPolygon: 'Pagamentos em Polygon são validados apenas na rede Polygon',
    ...
    requestManualVerificationOfUSDT: 'Solicite verificação manual de seus pagamentos USDT diretos inserindo o hash da transação. Um administrador revisará seu pagamento e o creditará manualmente.',
    ...
    hashInvalid: 'Hash Inválido',
    hashMustStartWith0x: 'O hash da transação deve começar com 0x e ter 66 caracteres\n\nHash atual: {{count}} caracteres',
    ...
    doYouWantToRequestNowPaymentsVerification: 'Deseja solicitar verificação manual deste pagamento NowPayments?\n\nValor: {{amount}} USDT\nMXI: {{mxi}} MXI\nOrdem: {{order}}\n\nUm administrador revisará seu pagamento e o aprovará manualmente. Este processo pode levar até 2 horas.',
    request: 'Solicitar',
    requestSent: 'Solicitação Enviada',
    ...
    withdrawalHistoryWillAppear: 'Seu histórico de retiradas aparecerá aqui assim que você fizer sua primeira retirada.',
    ...
    importantNoticeEditProfile: 'Aviso Importante',
    canOnlyEditBeforeKYCApproval: 'Você só pode editar as informações do seu perfil antes da aprovação da verificação KYC. Certifique-se de que todas as informações estejam corretas antes de enviar seu KYC.',
    emailAndReferralCodeCannotChange: 'Seu endereço de e-mail e código de referência não podem ser alterados. Se precisar atualizá-los, entre em contato com o suporte.',
    ...
    whyKYCIsRequired: 'Por que o KYC é necessário:',
    kycMandatoryInfo: '- A verificação KYC é obrigatória para todas as retiradas\n- Ajuda a prevenir fraude e lavagem de dinheiro\n- Garante conformidade com regulamentações financeiras\n- Protege sua conta e fundos\n- Processo de verificação único',
    personalInformationLabel: 'Informações Pessoais',
    fullLegalNameLabel: 'Nome Legal Completo',
    enterFullNameAsOnIDLabel: 'Digite seu nome completo como aparece em sua identificação',
    documentTypeLabel: 'Tipo de Documento',
    nationalIDLabel: 'RG',
    ...
    kycVerifiedTitle: 'KYC Verificado!',
    identityVerifiedMessage: 'Sua identidade foi verificada com sucesso. Agora você pode retirar seus fundos uma vez que atenda a todos os outros requisitos.',
    ...
    noMessagesYetTitle: 'Nenhuma mensagem ainda',
