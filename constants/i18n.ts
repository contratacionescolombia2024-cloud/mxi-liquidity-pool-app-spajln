...
const translations = {
  ...
  pt: {
    // I'll add Portuguese translations in the next message due to length constraints
    // For now, copying Spanish structure with Portuguese translations
    // [Portuguese translations would go here - same structure as Spanish]
  },
};
