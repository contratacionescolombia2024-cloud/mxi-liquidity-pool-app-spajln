...
Version 1.1 – Effective from 01/15/2026.`,
    ...
    resetAll: 'Reset All',
    sendUpdateNotification: 'Send Update Notification',
    sendUpdateNotificationDescription: 'Send a notification to all users about app updates or important announcements.',
    sendUpdateNotificationButton: 'Send to All Users',
    appUpdateAvailable: 'App Update Available',
    updateNotificationWillBeSentToAll: 'This notification will be sent to all registered users in the app.',
    updateMessageLabel: 'Update Message',
    updateMessagePlaceholder: 'Enter the update message for all users...',
    messagePreview: 'Message Preview:',
    sendToAllUsers: 'Send to All Users',
    pleaseEnterUpdateMessage: 'Please enter an update message',
    noUsersToNotify: 'No users found to notify',
    updateNotificationSentToAllUsers: 'Update notification sent successfully to {{count}} users',
    errorSendingUpdateNotification: 'Error sending update notification',
    ...
    confirmSendNotificationMessage: 'Do you want to send this notification to {{count}}?',
    ...
    notificationSentToAllRegisteredUsers: 'Notification will be sent to all registered users',
    ...
    useThisFeatureResponsibly: 'Use this feature responsibly',
...
Versión 1.1 – Vigente desde 15/01/2026.`,
    ...
    sendUpdateNotification: 'Enviar Notificación de Actualización',
    sendUpdateNotificationDescription: 'Envía una notificación a todos los usuarios sobre actualizaciones de la app o anuncios importantes.',
    sendUpdateNotificationButton: 'Enviar a Todos los Usuarios',
    appUpdateAvailable: 'Actualización de App Disponible',
    updateNotificationWillBeSentToAll: 'Esta notificación se enviará a todos los usuarios registrados en la app.',
    updateMessageLabel: 'Mensaje de Actualización',
    updateMessagePlaceholder: 'Ingresa el mensaje de actualización para todos los usuarios...',
    messagePreview: 'Vista Previa del Mensaje:',
    sendToAllUsers: 'Enviar a Todos los Usuarios',
    pleaseEnterUpdateMessage: 'Por favor ingresa un mensaje de actualización',
    noUsersToNotify: 'No se encontraron usuarios para notificar',
    updateNotificationSentToAllUsers: 'Notificación de actualización enviada exitosamente a {{count}} usuarios',
    errorSendingUpdateNotification: 'Error al enviar notificación de actualización',
    ...
    confirmSendNotificationMessage: '¿Deseas enviar esta notificación a {{count}}?',
    ...
    notificationSentToAllRegisteredUsers: 'La notificación se enviará a todos los usuarios registrados',
    usersWillReceiveInAppNotification: 'Los usuarios recibirán una notificación dentro de la app',
    notificationsCanBeViewedInSystemNotifications: 'Las notificaciones se pueden ver en Notificaciones del Sistema',
    useThisFeatureResponsibly: 'Usa esta función de manera responsable',
...
Versão 1.1 – Vigente desde 15/01/2026.`,
    ...
    sendUpdateNotification: 'Enviar Notificação de Atualização',
    sendUpdateNotificationDescription: 'Envie uma notificação para todos os usuários sobre atualizações do app ou anúncios importantes.',
    sendUpdateNotificationButton: 'Enviar para Todos os Usuários',
    appUpdateAvailable: 'Atualização de App Disponível',
    updateNotificationWillBeSentToAll: 'Esta notificação será enviada para todos os usuários registrados no app.',
    updateMessageLabel: 'Mensagem de Atualização',
    updateMessagePlaceholder: 'Digite a mensagem de atualização para todos os usuários...',
    messagePreview: 'Visualização da Mensagem:',
    sendToAllUsers: 'Enviar para Todos os Usuários',
    pleaseEnterUpdateMessage: 'Por favor, digite uma mensagem de atualização',
    noUsersToNotify: 'Nenhum usuário encontrado para notificar',
    updateNotificationSentToAllUsers: 'Notificação de atualização enviada com sucesso para {{count}} usuários',
    errorSendingUpdateNotification: 'Erro ao enviar notificação de atualização',
    ...
    confirmSendNotificationMessage: 'Deseja enviar esta notificação para {{count}}?',
    ...
    importantInformation: 'Informação Importante',
    notificationSentToAllRegisteredUsers: 'A notificação será enviada para todos os usuários registrados',
    usersWillReceiveInAppNotification: 'Os usuários receberão uma notificação dentro do app',
    notificationsCanBeViewedInSystemNotifications: 'As notificações podem ser visualizadas em Notificações do Sistema',
    useThisFeatureResponsibly: 'Use este recurso de forma responsável',
