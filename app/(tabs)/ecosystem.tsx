...
// En la Práctica Tab Content - NOW WITH INVESTOR PROFILES CONTENT AND NEW IMAGE
function EnLaPracticaTab() {
  ...
  return (
    <View>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/763bcff6-8fa4-4f22-b2ef-dce7c2e2f042.png')}
...
// Tokenómica Tab Content - UPDATED WITH NEW COMPREHENSIVE CONTENT
    ...
    <View>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        ...
        >
          ...
          <Text style={styles.sectionSubtitle}>{t('tokenomicsModelATitle')}</Text>
          <Text style={styles.bodyText}>
            {t('tokenomicsModelAIntro')}
          </Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelAPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelAPoint2')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelAPoint3')}</Text>
          </View>
          <Text style={styles.emphasisText}>
            {t('tokenomicsModelABenefit')}
          </Text>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>{t('tokenomicsModelBTitle')}</Text>
          <Text style={styles.bodyText}>
            {t('tokenomicsModelBIntro')}
          </Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelBPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelBPoint2')}</Text>
          </View>
          <Text style={styles.bodyText}>
            {t('tokenomicsModelBConclusion')}
          </Text>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>{t('tokenomicsModelCTitle')}</Text>
          <Text style={styles.bodyText}>
            {t('tokenomicsModelCIntro')}
          </Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelCPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelCPoint2')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelCPoint3')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelCPoint4')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsModelCPoint5')}</Text>
          </View>
          <Text style={styles.bodyText}>
            {t('tokenomicsModelCConclusion')}
          </Text>
        </LinearGradient>
      </View>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        ...
        >
          ...
          <View style={styles.tableContainer}>
            <View style={styles.tableRow}>
              <Text style={styles.tableHeader}>{t('tokenomicsTableStage')}</Text>
              <Text style={styles.tableHeader}>{t('tokenomicsTablePrice')}</Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>{t('tokenomicsPresale1')}</Text>
              <Text style={styles.tableCell}>0.40 USDT</Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>{t('tokenomicsPresale2')}</Text>
              <Text style={styles.tableCell}>0.70 USDT</Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>{t('tokenomicsPresale3')}</Text>
              <Text style={styles.tableCell}>1.00 USDT</Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>{t('tokenomicsEstimatedListing')}</Text>
              <Text style={styles.tableCell}>3.00 USDT</Text>
            </View>
          </View>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>{t('tokenomicsProjectionTitle')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsProjectionPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsProjectionPoint2')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsProjectionPoint3')}</Text>
          </View>
          <Text style={styles.bodyText}>
            {t('tokenomicsProjectionConclusion')}
          </Text>
        </LinearGradient>
      </View>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        ...
        >
          ...
          <Text style={styles.sectionSubtitle}>🟠 {t('tokenomicsBTCTitle')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>✔ {t('tokenomicsBTCPro1')}</Text>
            <Text style={styles.bulletPoint}>✖ {t('tokenomicsBTCCon1')}</Text>
            <Text style={styles.bulletPoint}>✖ {t('tokenomicsBTCCon2')}</Text>
          </View>
          <Text style={styles.bodyText}>
            → {t('tokenomicsBTCConclusion')}
          </Text>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>🔵 {t('tokenomicsETHTitle')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>✔ {t('tokenomicsETHPro1')}</Text>
            <Text style={styles.bulletPoint}>✖ {t('tokenomicsETHCon1')}</Text>
          </View>
          <Text style={styles.bodyText}>
            → {t('tokenomicsETHConclusion')}
          </Text>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>🟣 {t('tokenomicsADATitle')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>✔ {t('tokenomicsADAPro1')}</Text>
            <Text style={styles.bulletPoint}>✖ {t('tokenomicsADACon1')}</Text>
          </View>
          <Text style={styles.bodyText}>
            → {t('tokenomicsADAConclusion')}
          </Text>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>🟡 {t('tokenomicsSOLTitle')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>✔ {t('tokenomicsSOLPro1')}</Text>
            <Text style={styles.bulletPoint}>✖ {t('tokenomicsSOLCon1')}</Text>
          </View>
          <Text style={styles.bodyText}>
            → {t('tokenomicsSOLConclusion')}
          </Text>
        </LinearGradient>
      </View>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        ...
        >
          ...
          <Text style={styles.sectionSubtitle}>{t('tokenomicsShortTerm')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsShortTermPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsShortTermPoint2')}</Text>
          </View>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>{t('tokenomicsMediumTerm')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsMediumTermPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsMediumTermPoint2')}</Text>
          </View>

          <View style={styles.divider} />

          <Text style={styles.sectionSubtitle}>{t('tokenomicsLongTerm')}</Text>
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• {t('tokenomicsLongTermPoint1')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsLongTermPoint2')}</Text>
            <Text style={styles.bulletPoint}>• {t('tokenomicsLongTermPoint3')}</Text>
          </View>
        </LinearGradient>
      </View>
      ...
      <View style={[commonStyles.card, styles.visionCard]}>
        ...
        >
          <Text style={styles.visionEmoji}>🔵</Text>
          <Text style={styles.ctaTitle}>{t('tokenomicsConclusion')}</Text>
          <Text style={styles.ctaText}>{t('tokenomicsConclusionText')}</Text>
        </LinearGradient>
      </View>
    </View>
  );
    ...
    <View>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>⚠️ {t('risk1Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk1Desc1')}
          </Text>
          <Text style={styles.bodyText}>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>🔧 {t('risk2Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk2Desc1')}
          </Text>
          <Text style={styles.bodyText}>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>🚧 {t('risk3Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk3Desc')}
          </Text>
        </LinearGradient>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>⚖️ {t('risk4Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk4Desc')}
          </Text>
        </LinearGradient>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>💧 {t('risk5Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk5Desc')}
          </Text>
        </LinearGradient>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>📊 {t('risk6Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk6Desc1')}
          </Text>
          <Text style={styles.bodyText}>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>🏆 {t('risk7Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk7Desc')}
          </Text>
        </LinearGradient>
      ...
      {/* Risk 8: Community Dependency Risk */}
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          colors={[colors.primary + '10', colors.accent + '10']}
          start={{ x: 0, y: 0 }}
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>👥 {t('risk8Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk8Desc1')}
          </Text>
          <Text style={styles.bodyText}>
      ...
      <View style={[commonStyles.card, styles.contentCard]}>
        <LinearGradient
          ...
          style={styles.contentGradient}
        >
          <Text style={styles.sectionTitle}>🎯 {t('risk9Title')}</Text>
          <Text style={styles.bodyText}>
            {t('risk9Desc')}
          </Text>
        </LinearGradient>
