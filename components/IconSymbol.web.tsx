...
// Web-specific implementation with proper font loading
...
/**
 * An icon component that uses MaterialIcons on web with proper font loading.
 * This ensures icons display correctly in web builds.
 */
export function IconSymbol({
  ...
  useEffect(() => {
    ...
    const loadFont = async () => {
      try {
        ...
        // Set to true anyway to show fallback
        setFontLoaded(true);
      }
    };
    loadFont();
  ...
  if (!materialIconName) {
    ...
    materialIconName = "help-outline";
  }

  // Don't render until font is loaded to avoid showing question marks
  if (!fontLoaded) {
    return null;
  }
